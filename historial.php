...
<html>
    <head>
      ...
      <link href='images/Raspberry_logo_solo.ico' rel='shortcut icon' type='image/x-icon'>
				...
				<div class="col s12 l6 offset-l3 z-depth-2 " >
					<ul class="collection blue ">
						...
						<?php 
							...
							<?php
								$resultado2=$mysqli->query("SELECT * FROM historial WHERE id_usuario='".$_SESSION['id-usuario-logueado']."' AND  DATE_FORMAT(fecha, '%Y-%m-%d')= '$num_reg_dia' ORDER BY fecha DESC");
